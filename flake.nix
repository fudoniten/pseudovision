  ...
  outputs = { self, nixpkgs, flake-utils, nix-helpers }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        ...
        checks.schedule-integration =
          let
            testPkg = pseudovision;
            migrationSql =
              builtins.readFile ./resources/migrations/20260225-001-initial-schema.up.sql;
          in pkgs.nixosTest {
            ...
            nodes.server = { config, pkgs, ... }: {
              ...
              systemd.services.pseudovision = {
                ...
                serviceConfig = {
                  ExecStart = "${testPkg}/bin/pseudovision";
                  Restart = "on-failure";
                };
